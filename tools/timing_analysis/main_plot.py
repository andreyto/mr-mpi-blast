...
s40k_new_new_1000x40 = [133, 60, 30.2, 17.81, 10.37, 6.71, 4.64]
...
ax.loglog(x4, s40k_new_new_1000x40, 'rx-', linewidth=3, basex=2, basey=10, label='v4', markersize=10)
...
for i in range(0,len(x4)):
    ax.annotate(s40k_new_new_1000x40[i], xy=(x4[i], s40k_new_new_1000x40[i]),  xycoords='data',
...
ax.legend( (
            ...
            '40k sequences in 40 blocks (new3)'
            ), loc=1 )
