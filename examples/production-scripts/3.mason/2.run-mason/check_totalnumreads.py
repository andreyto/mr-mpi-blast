                ...
                if int(fname) in dict_taxid_numreads_illu:
                    ...
                    if num_generated_reads == dict_taxid_numreads_illu[int(fname)] or \
                       num_generated_reads - 1 == dict_taxid_numreads_illu[int(fname)]:
                        total_num_reads += num_generated_reads
                        print "OK", dict_taxid_numreads_illu[int(fname)], "==>", num_generated_reads, total_num_reads
                        i+=1
                        #pass
                    else:
                ...
                if ttt in dict_taxid_numreads_454:
                    ...
                    if num_generated_reads == dict_taxid_numreads_454[ttt] or \
                       ...
                       num_generated_reads + 1 == dict_taxid_numreads_454[ttt]:
                        total_num_reads += num_generated_reads
                        print "OK", dict_taxid_numreads_454[ttt], "==>", num_generated_reads, total_num_reads
                        i+=1
                        #pass
                    else:
        ...
        for fname2 in dirList3:
            if (fname2.find("TOTAL") > -1):
                ...
                if ttt in dict_taxid_numreads_illu:
                    ...
                    if num_generated_reads == dict_taxid_numreads_illu[ttt] or num_generated_reads - 1 == dict_taxid_numreads_illu[ttt] or num_generated_reads + 1 == dict_taxid_numreads_illu[ttt] :
                        total_num_reads += num_generated_reads
                        print "OK", dict_taxid_numreads_illu[ttt], "==>", num_generated_reads, total_num_reads
                        i+=1
                        #pass
                    else:
